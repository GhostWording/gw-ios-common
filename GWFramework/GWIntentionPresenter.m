...
+(NSArray*)allIntentions {
    return @[[GWIntentionPresenter intentionIThinkOfYou], [GWIntentionPresenter intentionILoveYou], [GWIntentionPresenter intentionILikeYou], [GWIntentionPresenter intentionIMissYou], [GWIntentionPresenter intentionIWantYou], [GWIntentionPresenter intentionHappyBirthday], [GWIntentionPresenter intentionJokes], [GWIntentionPresenter intentionIAmLate], [GWIntentionPresenter intentionThankYou], [GWIntentionPresenter intentionComeOverForDinner], [GWIntentionPresenter intentionIAmHereForYou], [GWIntentionPresenter intentionIAmSorry], [GWIntentionPresenter intentionHappyNewYear], [GWIntentionPresenter intentionGoodNight], [GWIntentionPresenter intentionSurpriseMe], [GWIntentionPresenter intentionAFewWordsForYou], [GWIntentionPresenter intentionHowAreYou], [GWIntentionPresenter intentionPositiveThoughts], [GWIntentionPresenter intentionFacebookStatus], [GWIntentionPresenter intentionComeBackToMe], [GWIntentionPresenter intentionGoodMorning], [GWIntentionPresenter intentionBravo], [GWIntentionPresenter intentionGetHomeSafe], [GWIntentionPresenter intentionHumorousInsults], [GWIntentionPresenter intentionThankYouForTheInvitation], [GWIntentionPresenter intentionSampleLetterInsurance], [GWIntentionPresenter intentionINeedAFavor], [GWIntentionPresenter intentionStopTheWorld], [GWIntentionPresenter intentionFarewellParty], [GWIntentionPresenter intentionRetirementCongratulations], [GWIntentionPresenter intentionWaitingForABaby], [GWIntentionPresenter intentionIAmAskingForAMeeting], [GWIntentionPresenter intentionCongratulationOnTheBirthOfYourBaby], [GWIntentionPresenter intentionIWantToKnowAboutYou], [GWIntentionPresenter intentionWeddingCongratulations], [GWIntentionPresenter intentionNoThankYou], [GWIntentionPresenter intentionWouldYouCareForADrink], [GWIntentionPresenter intentionSampleLetterForBanksAndCredits], [GWIntentionPresenter intentionSampleLetterConsumerRights], [GWIntentionPresenter intentionThereIsSomethingMissing], [GWIntentionPresenter intentionSampleLetter], [GWIntentionPresenter intentionCondolences], [GWIntentionPresenter intentionIWouldLikeToSeeYouAgain], [GWIntentionPresenter intentionThankYouForTheMeeting], [GWIntentionPresenter intentionRoutineIsLurking], [GWIntentionPresenter intentionLetMeIntroduceMyself], [GWIntentionPresenter intentionIAmLeavingYou], [GWIntentionPresenter intentionIAmJealous], [GWIntentionPresenter intentionCelebrateTheOccasion], [GWIntentionPresenter intentionLetUsStayInTouch], [GWIntentionPresenter intentionThankYouFortheGift], [GWIntentionPresenter intentionGiveMeSomeNews], [GWIntentionPresenter intentionWhatIsUpWithYouLately], [GWIntentionPresenter intentionMerryChristmas], [GWIntentionPresenter intentionSalutationClosingFormula]];
}
